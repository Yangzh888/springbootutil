package com.cn.springbootutil.common.http;
...
public class OkHttpUtil {
                ...
                if(field.getType().isAssignableFrom(List.class)){
                    ...
                    if(!CollectionUtils.isEmpty(list)){
                        for(int i=0;i<list.size();i++){
                            ...
                            Field[] listFields = listObj.getClass().getDeclaredFields();
                            for (Field field2 : listFields) {
                                field2.setAccessible(true);
                                Object value = field2.get(listObj);
                                String strValue = null==value?"":value.toString();
                                map.put(field.getName()+"["+i+"]."+field2.getName(), strValue);
                            }
                        }
                    }
                }else{
    ...
    public static String post(String url, Map<String, String> params) {
        String responseBody = "REPORT_SUCCESS";
